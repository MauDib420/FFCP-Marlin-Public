...
#define STRING_CONFIG_H_AUTHOR "MauDib" // Who made the changes.
...
#define CUSTOM_MACHINE_NAME "Hemera Creator Pro"
...
#define MAX_BED_POWER 235 // limits duty cycle to bed; 255=full current
  ...
  #define DEFAULT_bedKp 46.4943
  #define DEFAULT_bedKi 8.8637
  #define DEFAULT_bedKd 162.5907
 ...
 *                                      X, Y, Z, E0 [, E1[, E2...]]
 */
#define DEFAULT_AXIS_STEPS_PER_UNIT   { 188.2, 189.52, 800, 775.25 }
 ...
 *     O-- FRONT --+
 */
#define NOZZLE_TO_PROBE_OFFSET { 47.92, 2.7, -1.07 }
